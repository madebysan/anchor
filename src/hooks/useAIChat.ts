      ...
      try {
        ...
        const prompt = hasSelection
          ...
          : [
              ...
              "",
              "The document is accessible via your Read tool at the file path that was passed when this session started. Use it as needed to answer the question — read the whole file, search for specific content, or skim, depending on what the user is asking.",
              "",
              "## The user's question",
              userMessage,
              "",
